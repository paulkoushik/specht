###########################################################################
##
#W makedocrel.g             The SPECHT package          Koushik Paul
##
###########################################################################
...
MakeGAPDocDoc( "doc",     # path to the directory containing the main file
               ...
               SPECHTMANUALFILES,
               "Specht",# the name of the book used by GAP's online help
...
ExtractMyManualExamples( "Specht", "manual.xml", SPECHTMANUALFILES );
